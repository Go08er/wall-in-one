...
`c154c162fd650567ef8eda5d0e6d875b2b635a21`, including those changes. App v0.1.4
and its VM pin companion v0.1.3 in `flake.lock`, retaining that contract and
testing delayed cold-start status without a false startup failure or duplicate
runtime process.
